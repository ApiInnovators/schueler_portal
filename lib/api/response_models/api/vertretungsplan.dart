...
Vertretungsplan vertretungsplanFromJson(String str) =>
    Vertretungsplan.fromJson(json.decode(str));

String vertretungsplanToJson(Vertretungsplan data) =>
...
class Vertretungsplan {
  ...
  factory Vertretungsplan.fromJson(Map<String, dynamic> json) =>
      Vertretungsplan(
