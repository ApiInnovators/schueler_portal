...
List<Hausaufgabe> hausaufgabeFromJson(String str) => List<Hausaufgabe>.from(
    json.decode(str).map((x) => Hausaufgabe.fromJson(x)));

String hausaufgabeToJson(List<Hausaufgabe> data) =>
